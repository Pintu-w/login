    ...
    <div className="main-container ">
      <div className="container ">
       ...
       <div className="w-full py-5">
        <div>
          <h3 className="text-2xl mb-1 mt-3">User Managment</h3>
        ...
        <div className="">
          <h3 className="text-2xl mb-1 mt-5">Tournament Managment</h3>
